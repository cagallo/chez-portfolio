...
const ProjectCard = ({ project }) => {
  ...
  const ghRendering = !project.external_link ? <p className='gh-title-only'>GitHub: </p> : <p className='gh-title'>GitHub: </p>
  ...
  return (
    <section className="project-card">
      <div className='project-info-left'>
        ...
        { project.img !== null && <img className='project-imgs' src={project.img} alt='selected project'></img>}
      </div>
      <div className='project-info-right'>
        ...
        <ul className='tech-list'>
          { project.tech_stack.map(technology => {
            return (<li className='tech-name'key={index++}>{technology}</li>)
          }) }
        </ul>
        ...
        <div className='external-links'>
          { project.external_link !== null && <a href={project.external_link} className='deployed'>Check out the deployed App</a>} 
          {ghRendering}
